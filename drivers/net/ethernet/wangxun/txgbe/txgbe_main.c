...
#define DRV_VERSION     __stringify(1.3.3klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.3.3elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.3.3uos)
#else
#define DRV_VERSION     __stringify(1.3.3)
#endif
...
void txgbe_reset(struct txgbe_adapter *adapter)
{
	...
	if(txgbe_is_lldp(hw)) adapter->eth_priv_flags |= TXGBE_ETH_PRIV_FLAG_LLDP;
